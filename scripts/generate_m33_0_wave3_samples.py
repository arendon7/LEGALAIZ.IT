...
def _find(specs: list[dict], requested: str) -> dict:
    ...
    tokens = {
        ...
        "sast_traceability": ("trazabilidad", "sast"),
        "sast_registration": ("autorización", "gestión", "sast"),
        "sast_record_request": ("petición", "expediente", "sast"),
        "sast_inspection": ("inspección", "sast"),
        "sast_followup": ("reiteración", "sast"),
        "sast_package": ("resumen", "sast"),
