...
SERVICES_PARAGRAPH_AFTER_PT = 4
SERVICES_CLAUSE_BEFORE_PT = 4
SERVICES_SIGNATURE_BEFORE_PT = 4
...
_PRODUCT_PROFILES = {
    ...
    SERVICES_PRODUCT: {
        "profile": "M33.2-services-pagination",
        "paragraph_after_pt": SERVICES_PARAGRAPH_AFTER_PT,
        "clause_before_pt": SERVICES_CLAUSE_BEFORE_PT,
        "signature_before_pt": SERVICES_SIGNATURE_BEFORE_PT,
    },
}
