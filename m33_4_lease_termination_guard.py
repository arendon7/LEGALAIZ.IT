...
LANDLORD_TERMINATION_TEXT = (
    ...
    "legalmente reconocida, a favor de LA PARTE ARRENDATARIA, por seis (6) meses del canon "
    "vigente, para garantizar el cumplimiento de la causal dentro de los seis (6) meses "
    "siguientes a la restitución. El literal d) exige indemnización de uno punto cinco "
    "(1,5) meses de arrendamiento, pagada mediante el procedimiento del artículo 23."
    "\n"
